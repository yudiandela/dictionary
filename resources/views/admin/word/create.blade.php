...
@section('content')
    <div class="mx-auto my-6 lg:my-12 max-w-7xl">
        ...
        <h1 class="mb-4 text-2xl font-semibold">Create Words</h1>
            ...
            <div class="grid gap-5 lg:grid-cols-2">
                <div class="p-5 border rounded-md">
                    <div class="mb-4">
                        ...
                        <input name="words[0][formal_text]" autocomplete="off" value="" type="text" class="placeholder:italic placeholder:text-slate-400 w-full border rounded-md px-4 py-1.5 outline-none search-input placeholder:text-sm">
                    </div>

                    <div class="mb-4">
                        <label for="daily_text" class="block mb-2 text-sm font-medium text-gray-900">Daily Text</label>
                        <input name="words[0][daily_text]" autocomplete="off" value="" type="text" class="placeholder:italic placeholder:text-slate-400 w-full border rounded-md px-4 py-1.5 outline-none search-input placeholder:text-sm">
                    </div>

                    <div class="mb-4">
                        <label for="daily_text" class="block mb-2 text-sm font-medium text-gray-900">Language</label>
                        <select name="words[0][language_code]" id="" class="placeholder:italic placeholder:text-slate-400 w-full border rounded-md px-4 py-1.5 outline-none search-input placeholder:text-sm">
